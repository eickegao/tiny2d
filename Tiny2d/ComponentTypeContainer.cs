...
namespace Tiny2d
{
	public class ComponentTypeContainer
	{
		...
		internal static object DeepCopyGameObjComponent(Type type, GameObjComponent cloneFrom)
		{
			//Create a new instance of the component
			GameObjComponent comp = (GameObjComponent)type.Assembly.CreateInstance(type.FullName);
			//CopyPropertiesTo(comp, cloneFrom);
			cloneFrom.CopyValuesTo(comp);
			return comp;
		}
		
		internal static object DeepCopySceneComponent(Type type, SceneComponent cloneFrom)
		{
			//Create a new instance of the component
			SceneComponent comp = (SceneComponent)type.Assembly.CreateInstance(type.FullName);
			//CopyPropertiesTo(comp, cloneFrom);
			cloneFrom.CopyValuesTo(comp);
			return comp;
		}
